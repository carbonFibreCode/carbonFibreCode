...
### 🚀 Highlights
* **Open Source:** Active contributor to [**Twenty**](https://github.com/twentyhq/twenty) (YC23, 40k+ GitHub stars).
* **Currently Building:** Low-code app builder (Flutter & Kotlin) at [digia.tech](https://digia.tech).
